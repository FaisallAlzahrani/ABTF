...
import '../../inspection_management/models/work_order_model.dart';
import '../../inspection_management/screens/work_order_creation_screen.dart';

import 'work_order_details_screen.dart';
import '../../login/user_provider.dart';

class WorkOrderListScreenview extends StatefulWidget {
  const WorkOrderListScreenview({Key? key}) : super(key: key);

  @override
  State<WorkOrderListScreenview> createState() => _WorkOrderListScreenviewState();
}

class _WorkOrderListScreenviewState extends State<WorkOrderListScreenview> {
  ...
  Widget build(BuildContext context) {
    ...
    final isPlanner = userProvider.department_id == "Planning"; // Check if user is from Planning department
