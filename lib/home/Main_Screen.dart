...
import 'package:application_v1/Req_report/Main_daily/Daily_Maintanance.dart';
...
import '../Orders/MaintenanceKpiPage.dart';
                ...
                sliver: SliverGrid(
                  ...
                  delegate: SliverChildListDelegate([
                    ...
                    _buildDashboardTile(
                      ...
                      onTap: () {
                        print('Container KPIs clicked');
                        print('CopyRight© جميع الحقوق محفوظة لفيصل الزهراني © 2025');
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) {
                          return const MaintenanceKpiPage();
                        }));
                      },
                    ),
                    _buildDashboardTile(
